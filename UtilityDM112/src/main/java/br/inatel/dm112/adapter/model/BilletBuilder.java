...
public class BilletBuilder {
	...
	public BilletBuilder(BilletContent content) {
		...
		createEnderecoSac(
				uf, 
				content.getLocalidade(), 
				content.getCep(),
				content.getBairro(), 
				content.getLogradouro(),
				content.getNumero());
		createContaBancaria(
				BancosSuportados.BANCO_DO_BRASIL,
				content.getNumeroDaConta(), 
				"", 
				content.getCarteira(),
				content.getAgencia(), 
				content.getDigitoAgencia());
		createTitulo(
				content.getNumeroDoDocumento(), 
				content.getNossoNumero(),
				content.getValor(), 
				content.getDesconto(),
				content.getAcrecimo(), 
				content.getDataDoDocumento(),
				content.getDataDoVencimento());
		createBillet(
				content.getLocalPagamento1(),
				content.getInstrucaoAoSacado(), 
				content.getInstrucao1(),
	...
	public Endereco createEnderecoSac(UnidadeFederativa uf, String localidade,
	...
	public ContaBancaria createContaBancaria(BancosSuportados banco,
			Integer codigoDaConta, String digitoDaConta,
			Integer codigoCarteira, Integer codigoAgencia, String digitoAgencia) {

		contaBancaria = new ContaBancaria(banco.create());
		contaBancaria.setNumeroDaConta(new NumeroDaConta(codigoDaConta,
				digitoDaConta));
	...
	public Titulo createTitulo(String numeroDoDocumento, String nossoNumero,
			float valor, float desconto, float acrescimo, Date dataDoDocumento,
	...
	public void createBillet(String localPagamento1, String insturcaoAoSacado,
